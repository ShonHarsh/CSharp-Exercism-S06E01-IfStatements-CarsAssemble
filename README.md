...
### Download Command
`exercism download --track=csharp --exercise=cars-assemble`

### Submission Command
`exercism submit "Exercism\csharp\cars-assemble\CarsAssemble.cs"`

![Banner](Data/Images/CSharp-Exercism-S06-IfStatements-Title.png)
